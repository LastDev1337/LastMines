...
public class ResetTimeProvider extends DefaultMenu {

    public ResetTimeProvider(MenuConfig config, Player viewer, @Nullable Menu previousMenu) {
    ...
    protected void generate() {
        ...
        addArgument("RESET_TIME", String.valueOf(mine.getResetTime()));
    }
}
