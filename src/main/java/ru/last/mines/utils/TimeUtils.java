...
public class TimeUtils {
    ...
    private static final Pattern TIME_PATTERN = Pattern.compile("(\\d+)\\s*(ms|milliseconds|s|sec|seconds|m|min|minutes|h|hour|hours|d|day|days|w|week|weeks|mo|month|months|y|year|years|t|ticks)?", Pattern.CASE_INSENSITIVE);
