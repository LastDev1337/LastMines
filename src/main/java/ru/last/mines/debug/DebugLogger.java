...
public class DebugLogger {
    ...
    public void log(DebugType type, String message) {
        Main config = LastMines.getInstance().getConfigManager().getMainConfig();
        ...
        if (!enabled) return;
        Bukkit.getConsoleSender().sendMessage(ColorUtils.colorString("<white>[LastMines] <reset>" + prefix + color + message));
    }
